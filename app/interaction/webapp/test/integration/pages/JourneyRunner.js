sap.ui.define([
	...
	"interaction/test/integration/pages/Interactions_HeaderList",
	"interaction/test/integration/pages/Interactions_HeaderObjectPage",
	"interaction/test/integration/pages/Interactions_ItemsObjectPage"
], function (JourneyRunner, Interactions_HeaderList, Interactions_HeaderObjectPage, Interactions_ItemsObjectPage) {
    'use strict';

    var runner = new JourneyRunner({
        launchUrl: sap.ui.require.toUrl('interaction') + '/test/flp.html#app-preview',
        pages: {
